...
type TGender = 'men'|'women'|'kid'|'unisex'
...
const ProductAdminPage:FC<Props> = ({ product }) => {
  ...
  const onFilesSelected = async ( ev: ChangeEvent<HTMLInputElement> ) => {
          ...
          <Grid item xs={12} sm={ 6 }>
            ...
            <FormControl sx={{ mb: 1 }}>
              ...
              <RadioGroup
                ...
                onChange={ ({ target }) => setValue('gender', target.value as TGender, { shouldValidate: true }) }
              >
                {
